...
Output size (ISO) for this current config: 1,4 GB, 1,3 GiB   
...
Known issues:  
------------------------------------------  
* uenv-git: /home/user/Desktop/BazzArch-git/work/x86_64/airootfs/usr/lib/systemd/user/gpg-agent.service exists in filesystem  

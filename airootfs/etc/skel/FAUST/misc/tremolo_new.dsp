...
wet = hslider("wet_dry[name:wet/dry][tooltip:percentage of processed signal in output signal]",  100, 0, 100, 1) : /(100);
dry = 1 - wet;

process =  _<:*(dry),(*(wet): *(tremolo(hslider("freq",5,0.1,50,0.1),hslider("depth",0.5,0,1,0.01)))):>_;
